...
section_dir = chapter_dir / "lec13_monthly_algorithmic_problems" / "july23_palindromes"
if str(chapter_dir) not in sys.path: sys.path.append(str(chapter_dir))

from lec13_monthly_algorithmic_problems.july23_palindromes.dataset import PalindromeDataset, display_seq
from lec13_monthly_algorithmic_problems.july23_palindromes.model import create_model
