...
import wandb
from lec13_monthly_algorithmic_problems.october23_sorted_list.dataset import SortedListDataset
from lec13_monthly_algorithmic_problems.october23_sorted_list.model import create_model
...
class Trainer:
    ...
    def validation_step(self, toks: Tensor) -> Tensor:
        logits, targets = self._shared_train_validation_step(toks)
