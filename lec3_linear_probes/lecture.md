...
> **Colab: [exercises](https://colab.research.google.com/github/callummcdougall/ARENA_3.0/blob/main/chapter1_transformer_interp/exercises/lec3_linear_probes/1.3.1_Linear_Probes_exercises.ipynb?t=20260603) | [solutions](https://colab.research.google.com/github/callummcdougall/ARENA_3.0/blob/main/chapter1_transformer_interp/exercises/lec3_linear_probes/1.3.1_Linear_Probes_solutions.ipynb?t=20260603)**
...
section = "lec3_linear_probes"
chapter_dir = next(p for p in Path.cwd().parents if p.name == chapter)
section_dir = chapter_dir / section
if str(chapter_dir) not in sys.path:
    sys.path.append(str(chapter_dir))

import lec3_linear_probes.tests as tests
import lec3_linear_probes.utils as utils
...
GOT_ROOT = chapter_dir / "geometry-of-truth"  # geometry-of-truth repo
DD_ROOT = chapter_dir / "deception-detection"  # deception-detection repo
...
```python
load_dotenv(dotenv_path=str(chapter_dir / ".env"))
HF_TOKEN = os.getenv("HF_TOKEN")
assert HF_TOKEN, "Please set HF_TOKEN in your chapter1_transformer_interp/.env file"
```
